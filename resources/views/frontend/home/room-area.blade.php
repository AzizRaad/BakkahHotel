{{-- First Room Book Area --}}

@php
    $rooms = App\Models\Room::orderBy('created_at')->limit(4)->get();
@endphp
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-8 p-0">
                            <div class="room-card-content">
                                <h3>
                                    <a href="/room-details/{{ $room->id }}">{{ $room->roomType->name }}</a>
                                </h3>
                                ...
                                <a href="/room-details/{{ $room->id }}" class="book-more-btn">
                                    Book Now
                                </a>
                            </div>
                        </div>
